...
//            populate();
    ...
    void populate() {
        String section_url="http://svandroidnewsappbackend.wl.r.appspot.com/getMobileSectionGuardianCardNews?section=world";
...
//                    Toast.makeText(view.getContext(),String.valueOf(home_news_card_array.length()),Toast.LENGTH_SHORT).show();
...
//        NewsRecyclerViewAdapter newsRecyclerViewAdapter= new NewsRecyclerViewAdapter(allNewsTexts,allNewsImages,allNewsTimes,allNewsArticleIDs,allNewsDate,allNewsSection,getActivity());
//        //Set the adapter to the recycler view
//        newsRecyclerViewContainer.setAdapter(newsRecyclerViewAdapter);
//        newsRecyclerViewContainer.setLayoutManager(new LinearLayoutManager(getActivity()));
//
